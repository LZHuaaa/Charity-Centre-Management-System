...
public class DonorUI {
    ...
    public void filterDonors() {
        ListInterface<Donor> results = donorManagement.filterDonorsByType(categorizeDonors());
        ...
        if (results.isEmpty()) {
            ...
            System.out.println("All donors of " + donor.getDonorType() + " are displayed.");
        }
        pauseAndPrompt();
    }
